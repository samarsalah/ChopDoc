...
| Doc | Purpose |
|-----|---------|
| [ARCHITECTURE.md](./ARCHITECTURE.md) | Why modular monolith + diagram |
| [architecture-overview.png](./architecture-overview.png) | Architecture image |
| [architecture-overview.svg](./architecture-overview.svg) | Vector diagram |
